...
import 'package:flutter_m13/pertemuan13/components/content_widget.dart';
import 'package:flutter_m13/pertemuan13/components/progress_indicator_widget.dart';
import 'package:flutter_m13/pertemuan13/components/slider_widget.dart';
...
class _Pertemuan13ScreenState extends State<Pertemuan13Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Pertemuan 13')),
      body: Padding(
